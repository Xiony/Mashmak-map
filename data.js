...
const ICONS_DATA = [
  ...
  { category: CAT_VAISSEAU_RENFORTS, coords: [794.75, 228.25], icon: ICO_VAISSEAU_RENFORTS, image: "assets/capture/20250829231728_1.webp", description: "Il n’est pas sûr à 100% : de nombreuses fois j’ai nettoyé la zone sans qu’il apparaisse, et je ne connais pas la condition pour le faire apparaître." },
  ...
  { category: CAT_VAISSEAU_RENFORTS, coords: [584.75, 925], icon: ICO_VAISSEAU_RENFORTS, image: "assets/capture/20250829222925_1.webp", description: "Il est possible d'avoir un deuxiéme vaisseaux de renfort aprés le premier (pas à 100%)." },
  // Constantine
...
const CAT_SAFE = "Zone safe";

// Définition des zones
const ZONES_DATA = [
  { category: CAT_CRISTAUX, center: [545, 220], radius: 23, color: "blue" },
  { category: CAT_CRISTAUX, center: [185, 82], radius: 22, color: "blue" },
  { category: CAT_CRISTAUX, center: [340, 334], radius: 27, color: "blue" },
  { category: CAT_CRISTAUX, center: [361, 274], radius: 24, color: "blue" },
  { category: CAT_CRISTAUX, center: [179, 536], radius: 35, color: "blue" },
  { category: CAT_CRISTAUX, center: [217, 940], radius: 44, color: "blue" },
  { category: CAT_CRISTAUX, center: [415, 803], radius: 24, color: "blue" },
  { category: CAT_CRISTAUX, center: [609, 740], radius: 37, color: "blue" },
  { category: CAT_CRISTAUX, center: [624, 620], radius: 32, color: "blue" },
  { category: CAT_CRISTAUX, center: [675, 550], radius: 23, color: "blue" },
  { category: CAT_CRISTAUX, center: [239, 262], radius: 33, color: "blue" },
  { category: CAT_CRISTAUX, center: [910, 115], radius: 61, color: "blue" },
  { category: CAT_CRISTAUX, center: [926, 678], radius: 37, color: "blue" },
  { category: CAT_CRISTAUX, center: [771, 766], radius: 25, color: "blue" },
  { category: CAT_CRISTAUX, center: [131, 710], radius: 23, color: "blue" },
  { category: CAT_CRISTAUX, center: [455, 545], radius: 47, color: "blue" },
  { category: CAT_SAFE, center: [131, 456], radius: 10, color: "green" },
];
